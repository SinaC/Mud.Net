    ...
    public class JsonSerializerTests : MappingTestsBase
    {
        ...
        public void SerializeThenDeserialize_SimplePC()
        {
            var pcData = new PlayableCharacterData
            {
                ...
                Inventory = [],
                Auras = [],
                CharacterFlags = _flagFactory.CreateInstance<ICharacterFlags, ICharacterFlagValues>("Blind", "DetectMagic"),
                Immunities = _flagFactory.CreateInstance<IIRVFlags, IIRVFlagValues>("Fire", "Pouet"),
                Resistances = _flagFactory.CreateInstance<IIRVFlags, IIRVFlagValues>("Weapon", "Wood"),
                Vulnerabilities = _flagFactory.CreateInstance<IIRVFlags, IIRVFlagValues>(),
                ShieldFlags = _flagFactory.CreateInstance<IShieldFlags, IShieldFlagValues>(),
                Attributes = [],
