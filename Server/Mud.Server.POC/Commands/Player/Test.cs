...
public class Test : PlayerGameAction
{
    ...
    public override void Execute(IActionInput actionInput)
    {
        ...
        StringBuilder sb = generator.Generate("Test column duplicate", new TableGeneratorOptions { ColumnRepetionCount = 3 }, Enumerable.Range(0, 50).Select(x => new Tuple<string, string, int>("Value1_" + x.ToString(), "Value2_" + (50 - x).ToString(), x)));
        Actor.Send(sb);
