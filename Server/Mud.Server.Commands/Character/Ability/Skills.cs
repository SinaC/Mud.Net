...
level, current ability level, resource cost for every skills, passives
and weapons you've already learned and below your current level.
...
public class Skills : AbilitiesCharacterGameActionBase<ICharacter, ICharacterGameActionInfo>
{
