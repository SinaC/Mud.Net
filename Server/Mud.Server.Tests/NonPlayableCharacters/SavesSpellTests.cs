...
public class SavesSpellTests : TestBase
{
    ...
    private static INonPlayableCharacter GenerateNPC(IRandomManager randomManager, IResistanceCalculator resistanceCalculator, string imm, string res, string vuln, string characterFlags)
    {
        ...
        var npc = new NonPlayableCharacter(loggerMock.Object, null!, null!, messageForwardOptions, null!, randomManager, null!, null!, null!, null!, null!, null!, null!, null!, null!, raceManagerMock.Object, classManagerMock.Object, resistanceCalculator, null!, null!, null!, null!, null!);
