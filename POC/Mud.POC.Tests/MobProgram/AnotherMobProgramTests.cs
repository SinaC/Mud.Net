...
[TestClass]
public class AnotherMobProgramTests
{
    [TestMethod]
    public void Sample0()
    {
...
";
        ...
        var evaluator = new MobProgramEvaluatorWithVariables(context, variables);
...
echo This will not run if break triggered
";
...
";
        ...
        var context = new MobContext
        {
            ...
            Target = new Mob { Name = "Hero", IsPc = true, Level = 10 },
   ...
   or isgood $n
	 ...
	 break
      ...
      shout MOMMY!!! $N is poking me.
        ...
        {
            Self = new Mob { Name = "Goblin", Level = 15 },
            Target = new Mob { Name = "Hero", IsPc = true, Level = 3, Alignment = 0 },
            Secondary = new Mob { Name = "AnotherMob", Level = 50 }
        };
        var variables = new Dictionary<string, int> { ["hour"] = 10 };
...
and hour <= 19
  if rand 10
    ...
    mob echo $I {5opens{0 a {1curtain{0 and watches the {#sun{%set{0.
        ...
        {
            Self = new Mob { Name = "Goblin", Level = 15 },
            Target = new Mob { Name = "Hero", IsPc = true, Level = 35, Alignment = 0 },
            Secondary = new Mob { Name = "AnotherMob", Level = 50 }
        };
        var variables = new Dictionary<string, int> { ["hour"] = 10 };
