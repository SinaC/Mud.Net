...
namespace Mud.Server.Ability.Spell
{
    public abstract class SpellBase : ISpell
    {
        ...
        private string SetupFromCast(ISpellActionInput spellActionInput)
        {
            ...
            var abilityPercentage = Caster.GetAbilityLearnedInfo(AbilityInfo.Name);
        ...
        protected virtual void SaySpell()
        {
            ...
            {
                var abilityLearnInfo = target.GetAbilityLearnedInfo(AbilityInfo.Name);
                if (abilityLearnInfo.abilityLearned != null && abilityLearnInfo.abilityLearned.Level < target.Level)
