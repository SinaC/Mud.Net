...
public class Hobgoblin : RaceBase
{
    ...
    public override IIRVFlags Resistances => new IRVFlags("Disease", "Poison");
    ...
    public override IBodyParts BodyParts => new BodyParts( "Head", "Body", "Arms", "Legs", "Heart", "Brains", "Guts", "Hands", "Feet", "Fingers", "Ear", "Eye", "Tusks");
