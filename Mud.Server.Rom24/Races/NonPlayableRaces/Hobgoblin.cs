...
public class Hobgoblin : RaceBase
{
    public Hobgoblin(IFlagFactory flagFactory)
        : base(flagFactory)
    {
    }

    public override string Name => "hobgoblin";
    ...
    public override IIRVFlags Resistances => FlagFactory.CreateInstance<IIRVFlags, IIRVFlagValues>("Disease", "Poison");
    ...
    public override IBodyParts BodyParts => FlagFactory.CreateInstance<IBodyParts, IBodyPartValues>( "Head", "Body", "Arms", "Legs", "Heart", "Brains", "Guts", "Hands", "Feet", "Fingers", "Ear", "Eye", "Tusks");
