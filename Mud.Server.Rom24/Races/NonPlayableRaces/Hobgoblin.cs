...
namespace Mud.Server.Rom24.Races.NonPlayableRaces
{
    ...
    {
        public Hobgoblin(IServiceProvider serviceProvider)
        ...
        public override IIRVFlags Resistances => new IRVFlags(ServiceProvider, "Disease", "Poison");
        ...
        public override IBodyParts BodyParts => new BodyParts(ServiceProvider, "Head", "Body", "Arms", "Legs", "Heart", "Brains", "Guts", "Hands", "Feet", "Fingers", "Ear", "Eye", "Tusks");
