...
namespace Mud.Server.Rom24.Spells
{
    ...
    public class Identify : ItemInventorySpellBase
    {
        ...
        protected override void Invoke()
        {
            ...
            sb.AppendFormatLine("Object {0} is type {1}, extra flags {2}.", Item.DisplayName, Item.GetType().Name.Replace("IItem", string.Empty).Replace("Item", string.Empty), Item.ItemFlags.ToString());
        ...
        private StringBuilder AppendSpell(StringBuilder sb, string spell)
        {
