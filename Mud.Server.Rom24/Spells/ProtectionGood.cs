...
time.")]
[OneLineHelp("protects from the attacks of good beings")]
public class ProtectionGood : CharacterBuffSpellBase
{
    ...
    protected override (int level, TimeSpan duration, IAffect[] affects) AuraInfo
        ...
        new IAffect[] 
        {
            ...
            new CharacterShieldFlagsAffect { Modifier = ShieldFlagFactory.CreateInstance("ProtectGood"), Operator = AffectOperators.Or }
        });
