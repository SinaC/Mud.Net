...
public class CreateSpring : ItemCreationSpellBase
{
    ...
    public CreateSpring(ILogger<CreateSpring> logger, IRandomManager randomManager, IWiznet wiznet, IItemManager itemManager, ISettings settings)
    ...
    protected override void Invoke()
    {
        ...
        if (fountain == null)
        {
            ...
            Wiznet.Log($"SpellCreateFood: cannot create item from blueprint {Settings.SpringBlueprintId}.", WiznetFlags.Bugs, AdminLevels.Implementor);
            return;
        }
        int duration = Level;
