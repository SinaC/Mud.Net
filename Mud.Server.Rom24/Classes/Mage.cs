...
public class Mage : ClassBase
{
        ...
        : base(logger, abilityManager)
    {
        ...
        AddSkill(1, "staves", 2);
        AddSkill(1, "wands", 2);
        AddAbility(1, "magic missile", Domain.ResourceKinds.Mana, 15, CostAmountOperators.Fixed, 1);
        AddAbility(1, "ventriloquate", Domain.ResourceKinds.Mana, 5, CostAmountOperators.Fixed, 1);
        ...
        AddAbility(4, "floating disc", Domain.ResourceKinds.Mana, 40, CostAmountOperators.Fixed, 1);
        AddAbility(5, "invisibility", Domain.ResourceKinds.Mana, 5, CostAmountOperators.Fixed, 1);
        ...
        AddAbility(8, "refresh", Domain.ResourceKinds.Mana, 12, CostAmountOperators.Fixed, 1);
        AddAbility(9, "infravision", Domain.ResourceKinds.Mana, 5, CostAmountOperators.Fixed, 1);
        AddAbility(9, "locate object", Domain.ResourceKinds.Mana, 20, CostAmountOperators.Fixed, 1);
        AddAbility(9, "recharge", Domain.ResourceKinds.Mana, 60, CostAmountOperators.Fixed, 1);
        AddSkill(10, "lore", 6);
        ...
        AddAbility(10, "shocking grasp", Domain.ResourceKinds.Mana, 15, CostAmountOperators.Fixed, 1);
        AddAbility(10, "sleep", Domain.ResourceKinds.Mana, 15, CostAmountOperators.Fixed, 1);
        ...
        AddAbility(11, "giant strength", Domain.ResourceKinds.Mana, 20, CostAmountOperators.Fixed, 1);
        AddAbility(11, "weaken", Domain.ResourceKinds.Mana, 20, CostAmountOperators.Fixed, 1);
        AddAbility(12, "blindness", Domain.ResourceKinds.Mana, 5, CostAmountOperators.Fixed, 1);
        AddAbility(12, "know alignment", Domain.ResourceKinds.Mana, 9, CostAmountOperators.Fixed, 1);
        AddAbility(12, "protection evil", Domain.ResourceKinds.Mana, 5, CostAmountOperators.Fixed, 1);
        AddAbility(12, "protection good", Domain.ResourceKinds.Mana, 5, CostAmountOperators.Fixed, 1);
        AddAbility(13, "fireproof", Domain.ResourceKinds.Mana, 10, CostAmountOperators.Fixed, 1);
        AddAbility(13, "lightning bolt", Domain.ResourceKinds.Mana, 15, CostAmountOperators.Fixed, 1);
        AddAbility(13, "teleport", Domain.ResourceKinds.Mana, 35, CostAmountOperators.Fixed, 1);
        ...
        AddAbility(14, "farsight", Domain.ResourceKinds.Mana, 36, CostAmountOperators.Fixed, 1);
        ...
        AddAbility(15, "identify", Domain.ResourceKinds.Mana, 12, CostAmountOperators.Fixed, 1);
        ...
        AddAbility(17, "poison", Domain.ResourceKinds.Mana, 10, CostAmountOperators.Fixed, 1);
        ...
        AddAbility(19, "energy drain", Domain.ResourceKinds.Mana, 35, CostAmountOperators.Fixed, 1);
        AddPassive(20, "dodge", 8);
        AddAbility(20, "charm person", Domain.ResourceKinds.Mana, 5, CostAmountOperators.Fixed, 1);
        AddAbility(20, "shield", Domain.ResourceKinds.Mana, 12, CostAmountOperators.Fixed, 1);
        AddAbility(21, "haste", Domain.ResourceKinds.Mana, 30, CostAmountOperators.Fixed, 1);
        AddPassive(22, "parry", 8);
        AddAbility(22, "fireball", Domain.ResourceKinds.Mana, 15, CostAmountOperators.Fixed, 1);
        AddAbility(22, "mass invis", Domain.ResourceKinds.Mana, 20, CostAmountOperators.Fixed, 1);
        AddAbility(23, "plague", Domain.ResourceKinds.Mana, 20, CostAmountOperators.Fixed, 1);
        AddAbility(23, "slow", Domain.ResourceKinds.Mana, 30, CostAmountOperators.Fixed, 1);
        AddAbility(24, "pass door", Domain.ResourceKinds.Mana, 20, CostAmountOperators.Fixed, 1);
        AddAbility(24, "summon", Domain.ResourceKinds.Mana, 50, CostAmountOperators.Fixed, 1);
        AddPassive(25, "hand to hand", 8);
        AddSkill(25, "pick lock", 8);
        AddAbility(25, "stone skin", Domain.ResourceKinds.Mana, 12, CostAmountOperators.Fixed, 1);
        AddAbility(26, "call lightning", Domain.ResourceKinds.Mana, 15, CostAmountOperators.Fixed, 1);
        AddAbility(27, "gate", Domain.ResourceKinds.Mana, 80, CostAmountOperators.Fixed, 1);
        AddAbility(28, "acid blast", Domain.ResourceKinds.Mana, 20, CostAmountOperators.Fixed, 1);
        AddPassive(30, "second attack", 10);
        AddAbility(31, "acid breath", Domain.ResourceKinds.Mana, 100, CostAmountOperators.Fixed, 1);
        AddAbility(32, "word of recall", Domain.ResourceKinds.Mana, 5, CostAmountOperators.Fixed, 1);
        AddAbility(33, "chain lightning", Domain.ResourceKinds.Mana, 25, CostAmountOperators.Fixed, 1);
        AddAbility(34, "frost breath", Domain.ResourceKinds.Mana, 125, CostAmountOperators.Fixed, 1);
        AddAbility(35, "portal", Domain.ResourceKinds.Mana, 100, CostAmountOperators.Fixed, 2);
        AddAbility(36, "sanctuary", Domain.ResourceKinds.Mana, 75, CostAmountOperators.Fixed, 1);
        AddAbility(37, "lightning breath", Domain.ResourceKinds.Mana, 150, CostAmountOperators.Fixed, 1);
        AddAbility(39, "gas breath", Domain.ResourceKinds.Mana, 175, CostAmountOperators.Fixed, 1);
        AddAbility(40, "fire breath", Domain.ResourceKinds.Mana, 200, CostAmountOperators.Fixed, 1);
        AddAbility(40, "nexus", Domain.ResourceKinds.Mana, 150, CostAmountOperators.Fixed, 2);
