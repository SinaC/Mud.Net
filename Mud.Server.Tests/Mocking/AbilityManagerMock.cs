    ...
    internal class AbilityManagerMock : IAbilityManager
    {
        ...
        public IAbility this[string name] 
        {
            get
            {
                ...
                ability = new Ability(Domain.AbilityKinds.Passive, id, name, Domain.AbilityTargets.Custom, 12, Domain.AbilityFlags.None, string.Empty, string.Empty, string.Empty);
        ...
        public IAbility this[int id]
        {
            get
            {
                ...
                if (ability != null)
                    return ability;
                ability = new Ability(Domain.AbilityKinds.Passive, id, "ability"+id.ToString(), Domain.AbilityTargets.Custom, 12, Domain.AbilityFlags.None, string.Empty, string.Empty, string.Empty);
                _abilities.Add(ability);
                return ability;
            }
        }
