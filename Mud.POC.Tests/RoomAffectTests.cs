...
namespace Mud.POC.Tests
{
    ...
    public class RoomAffectTests
    {
        ...
        public void Room_OneRoomAddAffect_NoBaseValue_Test()
        {
            ...
            IAura roomAura = new Aura(null, null, AuraFlags.Permanent, 10, 10, new RoomFlagsAffect { Operator = AffectOperators.Add, Modifier = Domain.RoomFlags.Dark });
            room.AddAura(roomAura);
            room.Recompute();

            Assert.AreEqual(Domain.RoomFlags.None, room.BaseRoomFlags);
            Assert.AreEqual(Domain.RoomFlags.Dark, room.CurrentRoomFlags);
        }

        [TestMethod]
        public void Room_OneRoomAddAffect_IdenticalBaseValue_Test()
        {
            IRoom room = new Room("room1", Domain.RoomFlags.Dark);
            IAura roomAura = new Aura(null, null, AuraFlags.Permanent, 10, 10, new RoomFlagsAffect { Operator = AffectOperators.Add, Modifier = Domain.RoomFlags.Dark });
            room.AddAura(roomAura);
            room.Recompute();

            Assert.AreEqual(Domain.RoomFlags.Dark, room.BaseRoomFlags);
            Assert.AreEqual(Domain.RoomFlags.Dark, room.CurrentRoomFlags);
        }
        ...
        {
            IRoom room = new Room("room1", Domain.RoomFlags.ImpOnly);
            IAura roomAura = new Aura(null, null, AuraFlags.Permanent, 10, 10, new RoomFlagsAffect { Operator = AffectOperators.Add, Modifier = Domain.RoomFlags.Dark });
            room.AddAura(roomAura);
            room.Recompute();

            Assert.AreEqual(Domain.RoomFlags.ImpOnly, room.BaseRoomFlags);
            Assert.AreEqual(Domain.RoomFlags.Dark | Domain.RoomFlags.ImpOnly, room.CurrentRoomFlags);
        }
        ...
        {
            IRoom room = new Room("room1");
            IAura roomAura = new Aura(null, null, AuraFlags.Permanent, 10, 10, new RoomFlagsAffect { Operator = AffectOperators.Or, Modifier = Domain.RoomFlags.Dark });
            room.AddAura(roomAura);
            room.Recompute();
        ...
        {
            IRoom room = new Room("room1");
            IAura roomAura = new Aura(null, null, AuraFlags.Permanent, 10, 10, new RoomFlagsAffect { Operator = AffectOperators.Assign, Modifier = Domain.RoomFlags.Dark });
            room.AddAura(roomAura);
            room.Recompute();
        ...
        {
            IRoom room = new Room("room1");
            IAura roomAura = new Aura(null, null, AuraFlags.Permanent, 10, 10, new RoomFlagsAffect { Operator = AffectOperators.Nor, Modifier = Domain.RoomFlags.Dark });
            room.AddAura(roomAura);
            room.Recompute();

            Assert.AreEqual(Domain.RoomFlags.None, room.BaseRoomFlags);
            Assert.AreEqual(Domain.RoomFlags.None, room.CurrentRoomFlags);
        }
        ...
        public void Room_OneRoomNorAffect_DifferentBaseValue_Test()
        {
            ...
            Assert.AreEqual(Domain.RoomFlags.ImpOnly, room.BaseRoomFlags);
            Assert.AreEqual(Domain.RoomFlags.ImpOnly, room.CurrentRoomFlags);
        }
        ...
        {
            IRoom room = new Room("room1", Domain.RoomFlags.None);
            IAura roomAura = new Aura(null, null, AuraFlags.Permanent, 10, 10, new RoomFlagsAffect { Operator = AffectOperators.Add, Modifier = Domain.RoomFlags.Dark });
            room.AddAura(roomAura);
            IItem item = new ItemDummy("item1", room, null);
            IAura itemAura = new Aura(null, null, AuraFlags.Permanent, 10, 10, new RoomFlagsAffect { Operator = AffectOperators.Add, Modifier = Domain.RoomFlags.Dark });
