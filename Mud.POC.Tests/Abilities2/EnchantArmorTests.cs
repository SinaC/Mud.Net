...
namespace Mud.POC.Tests.Abilities2
{
    ...
    public class EnchantArmorTests : TestBase
    {
        ...
        public void ItemDestroyed()
        {
            ...
            SpellActionInput abilityActionInput = new SpellActionInput(new AbilityInfo(spell.GetType()), casterMock.Object, 0, false, parameters.rawParameters, parameters.parameters);
