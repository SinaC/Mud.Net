...
namespace Mud.Server.Character.PlayableCharacter.Ability
{
    ...
    public class Gain : PlayableCharacterGameAction
    {
        ...
        public INonPlayableCharacter Trainer { get; protected set; }
        ...
        private static readonly Lazy<TableGenerator<IAbilityLearned>> GainAbilityTableGenerator = new Lazy<TableGenerator<IAbilityLearned>>(() =>
        {
