...
namespace Mud.Server.Character
{
    public partial class Character : EntityBase, ICharacter
    {
        ...
        public void Act(ActOptions option, string format, params object[] arguments)
        {
            ...
            {
                // TODO: optimization ?  FormatActOneLine will always return the same string for every target different than 'this'
        ...
        public bool Move(ExitDirections direction, bool checkFighting, bool follow = false)
        {
            ...
            if (checkFighting && Fighting != null)
                Send("No way! You are still fighting!"+Environment.NewLine);
        ...
        public bool MultiHit(ICharacter enemy)
        {
            ...
            // Off hand (if no off-hand, loop is exited)
            for (int i = 0; i < attackCount; i++)
            {
        ...
        protected void RecomputeKnownAbilities()
        {
            ...
            //    _knownAbilities.AddRange(Repository.AbilityManager.Abilities.Select(x => new AbilityAndLevel(1,x)));
            //else
            {
                if (Class != null)
        ...
        protected void RecomputeCommands()
        {
            ...
            _fullCommands.AddRange(CharacterCommands.AsEnumerable().Select(x => new TrieEntry<CommandMethodInfo>(x.Key, x.Value))); // TODO: additional AddRange taking a IEnumerable<KeyValuePair<string,TValue>> or IDictionary<string,TValue>
            // Add Skill command
            ...
            foreach (AbilityAndLevel abilityAndLevel in _knownAbilities.Where(x => x.Level <= Level && x.Ability.Kind == AbilityKinds.Skill && (x.Ability.Flags & AbilityFlags.Passive) != AbilityFlags.Passive && (x.Ability.Flags & AbilityFlags.CannotBeUsed) != AbilityFlags.CannotBeUsed))
            {
                ...
                Func<string, CommandParameter[], bool> func = (rawParameters, parameters) => Repository.AbilityManager.Process(this, parameters);
